...
class VolumetricImagingWidget(QFrame):
    ...
    def add_components(self):
        ...
        self.dropdown_frequency.addItems(['0.1','0.2','0.5','1','2','5','8','10','12.5','16','20','25'])
        self.dropdown_frequency.setCurrentText('1')
        ...
        self.entry_number_of_planes_per_volume.setValue(1)
