...
bool enable_offset_velocity = true;
...
float SCREW_PITCH_Y_MM = 6.98; // z axis
float SCREW_PITCH_Z_MM = 1; // y axis

int MICROSTEPPING_X = 64;
int MICROSTEPPING_Y = 256;
int MICROSTEPPING_Z = 64;
...
long steps_per_mm_Y = (90*FULLSTEPS_PER_REV_Y*MICROSTEPPING_Y)/(2*3.14159265*100); // theta axis - 253.39 usteps/mm => 3.95 um per ustep
...
float MAX_VELOCITY_Y_mm = 50; // theta axis
...
static const long X_NEG_LIMIT_MM = -25; // x axis
static const long X_POS_LIMIT_MM = 25;	// x axis
...
static const long Z_NEG_LIMIT_MM = -5; // y axis
static const long Z_POS_LIMIT_MM = 5;  // y axis

// size 11 linear actuators
int X_MOTOR_RMS_CURRENT_mA = 1000;
int Z_MOTOR_RMS_CURRENT_mA = 1000;
// rotation stage
