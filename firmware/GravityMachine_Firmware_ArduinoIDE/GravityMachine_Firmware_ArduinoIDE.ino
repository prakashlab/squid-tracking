/********************************************************
  ...
  -by Deepak Krishnamurthy, Hongquan Li, François BENOIT du REY, Ethan Li
********************************************************/
//=================================================================================
// HEADER FILES
//=================================================================================
...
void loop()
{
  ...
  if(remote_focus_liquid_lens_trigger_received)
  {
    ...
    {
      digitalWrite(trigger_remote_focus,HIGH);
  ...
  {
    digitalWrite(trigger_remote_focus,LOW);
...
//    serial_send_fla/g('C', flag_trigger_camera + flag_trigger_camera_FL);
  ...
  { 
    ...
    if (buffer_rx_ptr == CMD_LENGTH) 
    {
        ...
        else if(buffer_rx[0]==9)
        {
          if(buffer_rx[1] == 0)
          {
            flag_trigger_camera = false;
            flag_trigger_camera_FL = false;
          }
          else if(buffer_rx[1] == 1)
          {
            flag_trigger_camera = true;
            flag_trigger_camera_FL = true;
          }
        }
        else if(buffer_rx[0] == SET_FREQUENCY_HZ)
        {
